...
Public Class DatDataBaseTransactions
    ...
    Function dataProcessing(ByVal PatientMRN As Integer, ByVal PatientFirstname As String, ByVal PatientMiddleName As String, _
                              ...
                              ByVal PatientStateId As String, ByVal PatientZip As String, ByVal PatientOrderNumber As String, _
                              ByVal PatientSpecimenCollect As String, ByVal GuarantorFirstname As String, ByVal GuarantorMiddleName As String, _
                              ...
                              ByVal GuarantorStateId As String, ByVal GuarantorZip As String, ByVal InsurancePlan As String, _
                              ByVal InsuranceFirstname As String, ByVal InsuranceNiddleName As String, ByVal InsuranceLastname As String, _
                              ByVal InsuranceGender As Char, ByVal InsuranceDOB As String, ByVal InsuranceRelationshipId As Integer, _
                              ByVal InsuranceAddress As String, ByVal InsuranceCity As String, ByVal InsuranceStateId As String, _
                              ByVal InsuranceZip As String, ByVal MedicalTestChain As String) As Integer
        ...
        Try
            ...
            'parameter = New SqlParameter
            'parameter.ParameterName = "@patientOrderNumber"
            'parameter.SqlDbType = SqlDbType.VarChar
            'parameter.Value = PatientOrderNumber
            'command.Parameters.Add(parameter)
